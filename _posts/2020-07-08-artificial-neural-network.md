...
##### First of all, I will not give you theoretical information about ANN in this post. For this post, you just need to know the algorithm and [entry-level artificial intelligence](https://bestsithineu.github.io/python/2020/07/10/artificial-neural-network-%C4%B1ntiuation/) and also you should have to install Anaconda or any python provider like pycharm or etc. [(Source code link.)](https://github.com/BestSithInEU/Artificial_Neural_Network_Example)
...
| \#  | RowNumber | CustomerId | CreditScore | Geography | Gender | Age | Tenure | Balance | NumOfPruducts | HasCrCard | HasCrCard | IsActiveMember | EstimatedSalary | Exited |
| --- | --------- | ---------- | ----------- | --------- | ------ | --- | ------ | ------- | ------------- | --------- | --------- | -------------- | --------------- | ------ |
...
##### For those who do not understand ":" and "-1". Firstly python starts counting from zero. ":" means whole row, and "-1" means till last column for our example. (something\[row] or something\[row, column])
